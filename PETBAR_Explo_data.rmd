...
## Mission 1 - Grand-Bénarre - 18 au 19 décembre 2018
...
knitr::kable(tab1[order(tab1$nest_ID),], caption = 'Tab. 1. Bilan des individus équipés avec un GPS')
```
 *ajouter point GPS des nids*  
 *demander à Djé la dernière date de contrôle de ces individus*
 * ATTENTION - les balises **PAC05** & **PAC13** ne sont pas répertoriées dans les comptes rendus (CR) de missions *tracking*. Cependant, deux balises (**PAC20** & **PAC14**) sont mentionnées dans le CR mais n'apparaissent pas dans le jeux de données.
   
## Mission 2 - Grand-Bénarre - 9 au 10 janvier 2019
...
knitr::kable(tab2[order(tab2$nest_ID),], caption = 'Tab. 2. Bilan du suivi des nids occupés par les adultes avec GPS à lors de la mission précédente')
```
  
## Mission 3 - Grand-Bénarre - 11 au 12 février 2019
  
Aucun oiseau avec GPS n'a été contrôlé sur la colonie. La communication entre les GPS et l'antenne deployée sur colonie (GPS point ?) semble avoir été faible, avec peu de données transmises : 4 GPS sur 10 et disparition du GPS **PAC20**.  
